...
export default function KuesionerPage() {
  ...
  const handleShare = () => {
    const text =
      "Halo warga! Yuk bantu isi kuesioner menu Ikan Bakar P. Tris untuk Puri Delta: https://ikanbakar99.vercel.app/kuesioner";
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <Card className="w-full max-w-md text-center py-8">
          <CardContent className="space-y-4 flex flex-col items-center">
            ...
            <Button onClick={handleShare} className="mt-4 gap-2 w-full max-w-[250px]">
              <Share2 className="w-4 h-4" />
              Bagikan ke Grup Warga
            </Button>
            <div className="mt-2 w-full max-w-[250px] flex flex-col gap-2">
              <a href="/" className="inline-flex h-10 items-center justify-center rounded-md border border-slate-200 bg-white px-4 py-2 text-sm font-medium hover:bg-slate-100 w-full transition-colors">
                Kembali ke Beranda
              </a>
            </div>
          </CardContent>
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center pt-8 p-4">
      <div className="w-full max-w-md mb-6">
        ...
        <p className="text-slate-500 text-center text-sm mt-1">
          Bantu kami hadirkan menu kesukaan Anda!
        </p>
      </div>
      ...
      <Card className="w-full max-w-md shadow-lg border-t-4 border-t-primary">
        <CardHeader>
          ...
          <CardDescription>Langkah {step} dari 4</CardDescription>
        </CardHeader>
        ...
        <CardContent className="min-h-[220px]">
          {step === 1 && (
            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="space-y-2">
                <Label htmlFor="nama">
                  Siapa nama / panggilan Anda? <span className="text-red-500">*</span>
                </Label>
                <Input
                  id="nama"
          ...
          {step === 2 && (
            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <Label>
                Lauk apa yang paling sering dicari untuk makan malam?{" "}
