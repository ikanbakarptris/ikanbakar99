...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ikanbakar99 - Ikan Bakar Ungaran" },
      { name: "description", content: "Ikan Bakar profesional di Ungaran. Melayani pesan antar ikan bakar dan ayam bakar." },
      { name: "author", content: "Ikanbakar99" },
      { property: "og:title", content: "Ikanbakar99 - Ikan Bakar" },
      { property: "og:description", content: "Ikan Bakar profesional di Ungaran. Melayani pesan antar ikan bakar dan ayam bakar." },
