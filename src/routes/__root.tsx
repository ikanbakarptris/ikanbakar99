...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Agung Bike Station - Bengkel Sepeda Bandungan" },
      { name: "description", content: "Bengkel sepeda profesional di Bandungan. Melayani servis ringan, setel velg, dan melayani antar-jemput." },
      { name: "author", content: "Agung Bike Station" },
      { property: "og:title", content: "Agung Bike Station - Bengkel Sepeda" },
      { property: "og:description", content: "Bengkel sepeda profesional di Bandungan. Melayani servis ringan, setel velg, dan melayani antar-jemput." },
