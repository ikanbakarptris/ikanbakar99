  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Lihat galeri menu dan ulasan asli pelanggan Ikan Bakar P. Tris, rumah makan ikan bakar di Perumahan Puri Delta, Sidoarjo.",
      },
    ],
  }),
});
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background selection:bg-primary/30">
      ...
      <main className="flex-1 pb-20">
        <section className="bg-gradient-to-b from-primary/5 via-primary/5 to-background py-16 md:py-24 border-b border-border/50 relative overflow-hidden">
        ...
        <AnimateIn delay={150} className="py-8 relative z-20">
          <CustomerReviews
            reviews={reviewsData}
        ...
        <section className="mx-auto max-w-3xl px-4 py-16 pb-24 relative z-30">
          <AnimateIn delay={300}>
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/10 via-primary/5 to-background border border-primary/20 p-8 text-center shadow-lift hover:shadow-xl transition-shadow duration-300">
              <div
                className="absolute -right-10 -top-10 size-40 rounded-full bg-primary/10 blur-3xl"
                aria-hidden="true"
              />
              <div
                className="absolute -left-10 -bottom-10 size-40 rounded-full bg-primary/10 blur-3xl"
                aria-hidden="true"
              />
              ...
              <span className="inline-flex items-center justify-center size-12 rounded-full bg-primary/20 mb-4">
                <svg
                  viewBox="0 0 24 24"
                  className="size-6 text-primary fill-current"
                  aria-hidden="true"
                >
              ...
              <p className="text-muted-foreground md:text-lg mb-6 leading-relaxed max-w-xl mx-auto">
                Sudah mencoba ikan bakar kami? Tulis ulasan jujur Anda di Google Maps, tunjukkan saat
                kunjungan berikutnya, dan dapatkan{" "}
                <strong className="text-primary font-bold">Diskon Khusus 10%</strong> untuk pesanan
                berikutnya!
              </p>
              ...
              <a
                ...
                className="inline-flex items-center justify-center rounded-2xl bg-primary px-8 py-3.5 text-sm font-bold text-primary-foreground shadow-lift transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20 hover:bg-primary/90 active:scale-95 will-change-transform"
              >
                Tulis Ulasan di Google Maps
                <svg viewBox="0 0 24 24" className="ml-2 size-4 fill-current" aria-hidden="true">
